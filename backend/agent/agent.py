"""Real-time system design agent driven by upstream visual_delta text."""
...
the user is building. The graph is your source of truth. Every time you receive
a visual_delta update, determine what structural change it describes and call
the appropriate graph mutation tool.
...
class WhiteboardAgent:
    """
    Stateful LangChain agent for real-time whiteboard updates.
    ...
    Audio input is intentionally excluded.
    """
    ...
    def process_visual_delta(self, visual_delta: str, timestamp_ms: int) -> str:
        """
        Analyze a single plain-text visual_delta update and apply graph mutations.
        ...
        Args:
            visual_delta: Plain-English description of what changed visually.
        ...
        human_msg = HumanMessage(
            content=(
                f"[t={timestamp_ms}ms] Analyze this visual_delta and call the appropriate graph tools: "
                f"{visual_delta}"
            )
        )
